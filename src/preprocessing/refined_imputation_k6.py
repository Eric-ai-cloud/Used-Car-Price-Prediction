...
# ========================
print("\n【1】加载带簇标签的数据（k=6）...")
train_df = pd.read_csv('train_with_clusters_k6.csv')
test_df = pd.read_csv('test_with_clusters_k6.csv')
...
📁 输出文件:
   - train_refined_k6.csv: 精填后的训练集
   - test_refined_k6.csv: 精填后的测试集
